...
if(searchButton){
    searchButton.addEventListener('click', () =>{
        searchContent.classList.add('showSearch')
    })
}
...
if(searchClose){
    searchClose.addEventListener('click', () =>{
        searchContent.classList.remove('showSearch')
    })
}
...
if(loginButton){
    loginButton.addEventListener('click', () =>{
        loginContent.classList.add('showLogin')
    })
}
...
if(loginClose){
    loginClose.addEventListener('click', () =>{
        loginContent.classList.remove('showLogin')
    })
}
...
sr.reveal(`.homeData, .featuredContainer, .newContainer, .joinData, .testimonialsContainer, .footer`)
sr.reveal(`.homeImages`, {delay: 600})
sr.reveal(`.servicesCard`, {interval: 100})
